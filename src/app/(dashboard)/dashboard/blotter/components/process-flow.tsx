    ...
    <div className="w-full py-4">
      ...
      <div className="relative">
        ...
        <div className="hidden sm:block">
          ...
          {/* Mediation outcome - Failed */}
          {currentStep >= 5 && !resolvedAtMediation && (
            <div className="absolute left-[33%] top-[50%] transform translate-y-2">
              <div className="border-2 border-amber-500 border-dashed h-16 w-0"></div>
              <ArrowDownCircle className="w-5 h-5 text-amber-500 absolute -bottom-2 -left-2" />
              <div className="absolute -bottom-8 -left-12 text-xs text-amber-600 font-medium">
                Not resolved
              </div>
            </div>
          )}
          ...
          {/* Conciliation outcome - Failed */}
          {currentStep >= 6 && !resolvedAtConciliation && currentStatus !== BlotterCaseStatus.RESOLVED && (
            <div className="absolute left-[58%] top-[50%] transform translate-y-2">
              <div className="border-2 border-amber-500 border-dashed h-16 w-0"></div>
              <ArrowDownCircle className="w-5 h-5 text-amber-500 absolute -bottom-2 -left-2" />
              <div className="absolute -bottom-8 -left-12 text-xs text-amber-600 font-medium">
                Not resolved
