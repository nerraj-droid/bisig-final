...
export default function NewExpensePage() {
    ...
    // Fetch project data and available transactions
    useEffect(() => {
    ...
    const onSubmit = async (values: FormValues) => {
        try {
            ...
            const expenseData = {
                ...
                transactionId: values.linkToTransaction ? values.transactionId : undefined,
            };
        ...
        <div className="container p-6">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        {project ? `Record an expense for ${project.title} (${project.projectCode})` : "Loading project..."}
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    {error && (
                                ...
                                render={({ field }) => (
                                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                                        <div className="space-y-0.5">
                                            <FormLabel className="text-base">Link to Existing Transaction</FormLabel>
                                            <FormDescription>
                                                Connect this expense to an existing financial transaction
                                            </FormDescription>
                                        </div>
                                        <FormControl>
                                            <Switch
