...
export async function generateReportPDF({
    ...
    ], doc.internal.pageSize.width / 2, 160, { align: "center" })
    ...
    autoTable(doc, {
        ...
        body: genderDistribution.map(g => [
            g.gender,
            g.count,
            `${((g.count / totalResidents) * 100).toFixed(1)}%`,
        ]),
        styles: {
            fontSize: 10,
            cellPadding: 5,
    ...
    autoTable(doc, {
        ...
        body: ageGroups.map(a => [
            a.range,
            a.count,
            `${((a.count / totalResidents) * 100).toFixed(1)}%`,
        ]),
        styles: {
            fontSize: 10,
            cellPadding: 5,
    ...
    const addFooter = (pageNum: number) => {
        ...
        // Center - Contact
        doc.text(
            "Contact: bisig@example.com | (123) 456-7890",
            doc.internal.pageSize.width / 2,
            footerTop + 20,
            { align: "center" }
        )
